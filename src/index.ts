...
import {
  ...
  createWorkflowRunSavedTool,
  createWorkflowShowTool,
} from "./tools.js"
...
export type { RunnerConfig, SDKClient } from "./runner.js"
...
export default { id: "opencode-dynamic-workflows", server } satisfies PluginModule
export { server }
